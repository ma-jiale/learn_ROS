...
import roslib
roslib.load_manifest('catch_fruits')
import sys
import rospy
import cv2
...
def save_contour_centers(img, h_range, s_range, v_range, output_filename="/home/majiale/ROS_hmk_ws/src/catch_fruits/scripts/contour_centers.npy"):
    """
